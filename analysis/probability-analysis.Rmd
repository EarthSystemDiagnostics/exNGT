...
method <- c("main", "main", "main", "simple", "simple")
...
p <- sprintf("%1.2e", c(
  ...
  plotHistogram(stack.method = "main", piPeriod = 1000 : 1850, method = 1, plot = FALSE),

  plotHistogram(stack.method = "main", piPeriod = 1000 : 1900, method = 1, plot = FALSE),

  plotHistogram(stack.method = "main", piPeriod = 1000 : 1900, method = 2, plot = FALSE)
))
